...
class Rectangle:
    def __init__(self, x, y, w, h):
        self.bottom_left = Point3(x,y)
        self.top_right = Point3(x + w, y + h)
    def move(self, dx, dy):
...
#-------------------------------------------------------------------------------
a = [Rectangle(0,0,10,20), Point3(5,10)]
...
class Point5:
    ...
    def __add__(self, other):
        return Point5(self.x + other.x, self.y + other.y)
...
#-------------------------------------------------------------------------------
jump = [Point5(x,y) for x in [-2,2] for y in [-1,1]] \
       + [Point5(x,y) for x in [-1,1] for y in [2,-2]]
...
class Knight:
    def __init__(self, x, y):
        self.position = Point5(x, y)
    def __iter__(self):
        return KnightsIterator(self.position)
k = Knight(4,4)
for p in k:
    test( k.position.distance(p) == math.sqrt(5) )
test( (Point5(2,3) in k) == True and (Point5(5,5) in k) == False )
#-------------------------------------------------------------------------------
class Circle(object):
    pi = 3.14159
...
c1.pi = 3.14159
test( c1.pi == 3.14159 and c2.pi == 3.141592653589793  and Circle2.pi == 3.141592653589793  )
#-------------------------------------------------------------------------------
